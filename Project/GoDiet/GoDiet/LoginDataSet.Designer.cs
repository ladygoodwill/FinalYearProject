...
namespace GoDiet {
    ...
    public partial class LoginDataSet : global::System.Data.DataSet {
        ...
        public partial class tblUsersDataTable : global::System.Data.TypedTableBase<tblUsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public tblUsersRow AddtblUsersRow(string Username, string Password, string Name, string Surname, int Height, double Weight, string Email) {
        ...
        public partial class tblUsersRow : global::System.Data.DataRow {
            ...
            public int Height {
                get {
                    return ((int)(this[this.tabletblUsers.HeightColumn]));
                }
                set {
            ...
            public double Weight {
                get {
                    return ((double)(this[this.tabletblUsers.WeightColumn]));
                }
                set {
...
namespace GoDiet.LoginDataSetTableAdapters {
    ...
    public partial class tblUsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblUsers] WHERE (([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ([Height] = @Original_Height) AND ([Weight] = @Original_Weight) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tblUsers] ([Username], [Password], [Name], [Surname], [Height], [Weight], [Email]) VALUES (@Username, @Password, @Name, @Surname, @Height, @Weight, @Email);
SELECT Username, Password, Name, Surname, Height, Weight, Email FROM tblUsers WHERE (Username = @Username)";
...
SELECT Username, Password, Name, Surname, Height, Weight, Email FROM tblUsers WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GoDiet.Properties.Settings.Default.LoginCredentialsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Name, Surname, Height, Weight, Email FROM dbo.tblUsers" +
                "";
        ...
        public virtual int Fill(LoginDataSet.tblUsersDataTable dataTable) {
        ...
        public virtual LoginDataSet.tblUsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataSet.tblUsersDataTable dataTable = new LoginDataSet.tblUsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet.tblUsersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Username, string Original_Password, string Original_Name, string Original_Surname, int Original_Height, double Original_Weight, string Original_Email) {
        ...
        public virtual int Insert(string Username, string Password, string Name, string Surname, int Height, double Weight, string Email) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Name, string Surname, int Height, double Weight, string Email, string Original_Username, string Original_Password, string Original_Name, string Original_Surname, int Original_Height, double Original_Weight, string Original_Email) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Name, string Surname, int Height, double Weight, string Email, string Original_Username, string Original_Password, string Original_Name, string Original_Surname, int Original_Height, double Original_Weight, string Original_Email) {
            return this.Update(Original_Username, Password, Name, Surname, Height, Weight, Email, Original_Username, Original_Password, Original_Name, Original_Surname, Original_Height, Original_Weight, Original_Email);
        }
    }
